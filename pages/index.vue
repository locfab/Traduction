...
const files = ref<string[]>(["verbA-I.csv", "verbJ-O.csv", "verbP-R.csv", "verbS-T.csv", "mots1.csv", "mots2.csv", "mots3.csv", "mots4.csv", "interrog.csv", "expr.csv", "expr2.csv", "d-m-y.csv", "son.csv", "compar.csv"]);
